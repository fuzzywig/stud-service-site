    ...
    try {
        ...
        if (!adminEmail || !userEmail || !userName || !advertId || !title || !intent || !breedOrType) {
            ...
            return res.status(400).json({
                ...
                required: ['adminEmail', 'userEmail', 'userName', 'advertId', 'title', 'intent', 'breedOrType'],
...
app.post('/api/send-new-review-email', async (req, res) => {
    ...
    const msg = {
        ...
        dynamicTemplateData: {
            ...
            reviewUrl: `https://mypetconnect.co.uk//profile/${ownerData.uid}?tab=reviews`,
            profileUrl: `https://mypetconnect.co.uk//profile/${ownerData.uid}`,
            advertUrl: `https://mypetconnect.co.uk//advert-details/${advertData.id}`,
