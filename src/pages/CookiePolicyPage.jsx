...
const CookiePolicyPage = () => {
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Cookie Policy | MyPetConnect – Stud Dogs & Pets for Sale UK</title>
                <meta
                    name="description"
                    content="Learn how MyPetConnect uses cookies to enhance your experience, personalise content, and analyse traffic. Review our cookie usage and your options."
                />
            </Helmet>
